...
Here is a good start: <http://www.gwtproject.org/gettingstarted.html>

```
brew install ant
brew install gwt
webAppCreator -junit ~/.m2/repository/junit/junit/4.8.2/junit-4.8.2.jar -out gwt-demo example.gwtdemo
```
...
GWT heavily depends on IDE supports.

For now, there is eclipse plugin provided by GWT, but the IDEA plugin is not supported by community version now.
...
To launch your web app in GWT development mode, go to the Run menu and choose:
  ...
  named "gwtdemo".  Select and click "Debug".
